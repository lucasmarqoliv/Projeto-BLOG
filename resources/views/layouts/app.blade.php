    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light bg-primary">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                <a class="nav-link" href="{{ route('post.create') }}">Criar Postagem</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('categoria.create') }}">Criar Categoria</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('tag.cadastrar') }}">Criar Tag</a>
                </li>
            </ul>
        </nav>
    </div>
